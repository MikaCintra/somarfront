...
import { ChatService, Conversation, Message } from '../../features/chat/services/chat.service';
...
@Component({
  ...
  templateUrl: '../../features/chat/pages/chat/chat.html',
  styleUrl: '../../features/chat/pages/chat/chat.scss'
})
